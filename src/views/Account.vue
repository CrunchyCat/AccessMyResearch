...
<div >
     ...
     <!-- <P>This will be the Account page</P> -->
                        ...
                        <form method="post">
                          ...
                          <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                              ...
                              <input type="text" class="form-control" id="input01" value="jones" required=""> </div>
                            <!-- /form column -->
                            <!-- form column -->
                            <div class="col-md-6 mb-3">
                              <label for="input02">Last Name</label>
                              <input type="text" class="form-control" id="input02" value="Jesse" required=""> </div>
                            <!-- /form column -->
                          </div>
                          <!-- /form row -->
                          <!-- .form-group -->
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="input03" value="jne0@accessmyresearch.org" required=""> </div>
                          <!-- /.form-group -->
                          <!-- .form-group -->
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="input05" value="Jesse_jone2" required="">
